...
**Generated (UTC):** 2026-08-30T09:58:52Z  
...
| Metric | Value |
|--------|-------|
| Candidate area features (9B base) | **2,998** |
| Total candidate terrain area | **8,095.5 ha** |
...
| `exclude_ecological_sensitive_areas` | APPLIED: 3134167 pixels excluded (ESA WorldCover Tree cover/Water + KWLS) | APPLIED |
